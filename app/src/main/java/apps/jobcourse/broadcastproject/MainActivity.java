...
public class MainActivity extends AppCompatActivity {
    ...
    private CustomReceiver mCustomReciever = new CustomReceiver();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LocalBroadcastManager.getInstance(this).registerReceiver(mCustomReciever, intentFilter1);
    }
    ...
    protected void onDestroy() {
        ...
        LocalBroadcastManager.getInstance(this).unregisterReceiver(mCustomReciever);
    }
}